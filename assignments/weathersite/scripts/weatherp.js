...
let apiURLpreston = "https://api.openweathermap.org/data/2.5/weather?id=5604473&units=imperial&APPID=cc37759cf1ea1a86889a1de5b1352725";
weatherRequest.open('GET', apiURLpreston, true);
weatherRequest.send();
