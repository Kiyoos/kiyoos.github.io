...
let apiURLsodasprings = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=cc37759cf1ea1a86889a1de5b1352725";
weatherRequest.open('GET', apiURLsodasprings, true);
weatherRequest.send();
